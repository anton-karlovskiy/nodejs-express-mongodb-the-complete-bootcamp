...
export const isLoggedIn = async (req: Request, res: Response, next: NextFunction) => {
  if (req.cookies?.jwt) {
    try {
      const decoded = jwt.verify(req.cookies.jwt as string, process.env.JWT_SECRET!) as JwtDecoded;
...
export const resetPassword = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  const body = req.body as { password: string; passwordConfirm: string };
...
export const updatePassword = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  const body = req.body as { passwordCurrent: string; password: string; passwordConfirm: string };
